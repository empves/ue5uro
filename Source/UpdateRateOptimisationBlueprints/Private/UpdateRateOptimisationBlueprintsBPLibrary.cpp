...
void UUpdateRateOptimisationBlueprintsBPLibrary::SetUpdateRateOptimisationMode(USkinnedMeshComponent* SkinnedMeshComponent,
...
void UUpdateRateOptimisationBlueprintsBPLibrary::SetEnableUpdateRateOptimisationsOnSkinnedMesh(
	USkinnedMeshComponent* SkinnedMeshComponent, bool bEnable)
{
	if (!SkinnedMeshComponent)
	{
...
void UUpdateRateOptimisationBlueprintsBPLibrary::SetVisibleDistanceFactorThresholds(USkinnedMeshComponent* SkinnedMeshComponent,
...
void UUpdateRateOptimisationBlueprintsBPLibrary::SetLODToFrameSkipMap(USkinnedMeshComponent* SkinnedMeshComponent,
                                                                      const TMap<int32, int32>& LODToFrameSkipMap)
{
	if (!SkinnedMeshComponent)
	{
...
void UUpdateRateOptimisationBlueprintsBPLibrary::SetLODToFrameSkipArray(USkinnedMeshComponent* SkinnedMeshComponent,
                                                                        const TArray<int32>& LODToFrameSkipArray)
{
	if (!SkinnedMeshComponent)
	{
